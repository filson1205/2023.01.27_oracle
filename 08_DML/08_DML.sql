...
-- INSERT INTO 테이블명 VALUSE (데이터, 데이터, ...);
...
VALUES
(
  '900', '장채현', '901123-1080503', 'jang_ch@greedy.com', '01055556666'
, 'D1', 'J7', 'S3', 430000, 0.2
, '200', SYSDATE, NULL
);
...
-- EMP_DEPT_D1테이블에 EMPLOYEE 테이블에서 부서코드가 D1인 직원을 조회하여
...
-- 평상시 유재식 사원을 부러워하던 방명수 사원의 급여와 보너스를
